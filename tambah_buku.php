            ...
            <div class="card-body">
                <form method="POST" action="proses_tambah_buku.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_buku" value="" placeholder="Masukkan Nama buku" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Buku" required>
                    </div>
                    <div class="mb-3">
